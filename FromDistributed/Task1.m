...
%% MULTIOBJECTIVE DISTRIBUTED OPTIMIZATION %%
    ...
    set(w, 'OuterPosition', [scrsz(3)/3 scrsz(4)/3 270 100]);
    ...
    for t = 1:MAXITERS-1
        ...
        for i = 1:N
            ...
            grad_f(:, t,i) = (2*Q(:,:,i)*LM(:,t,i) + R(:,i));
            grad_f(:, t+1,i) = (2*Q(:,:,i)*LM(:,t+1,i) + R(:,i));
            
            % Gradient descent update
            S(:,t+1,i) = S(:,t+1,i) + N*(grad_f(:,t+1,i) - grad_f(:,t,i));
